	  ...
	  */
	  ...
	  Gui(cmd, arg1:="", args*)
	  {
		...
		Case "GetRange":
		  ...
		  FindText_HotkeyIf.Show("NA x0 y0 w0 h0")
		  HotIfWinExist("FindText_HotkeyIf")
		  Hotkey("*LButton", Gui_Off, "On")
		  Hotkey("*LButton Up", Gui_Off, "On")
		  CoordMode("Mouse")
		  oldx:=oldy:="", r:=Lang["s7"]
		  Critical("Off")
		  Loop
		  ...
		  Critical()
		  this.RangeTip()
		  Hotkey("*LButton", Gui_Off, "Off")
		  Hotkey("*LButton Up", Gui_Off, "Off")
		  HotIfWinExist()
		  FindText_HotkeyIf.Destroy()
		...
		Case "Apply":
		  ...
		  if (NowHotkey!="")
			Hotkey("*" NowHotkey, , "Off")
		  k:=SetHotkey1!="" ? SetHotkey1 : SetHotkey2
		  if (k!="")
			Hotkey("*" k, Gui_ScreenShot, "On")
